...
?>
    <div class="wrapper">
        ...
        echo '<a href="seating_visualization.php" class="btn btn-secondary">Seating Visualization</a>';
        echo '</div>';
        ?>
                ...
                <table class="table table-hover text-center">
                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <th class="py-3 bg-light"><input type="text" name="start" class="form-control" size=4></th>
                                <th class="py-3 bg-light"><input type="text" name="end" class="form-control" size=4></th>
